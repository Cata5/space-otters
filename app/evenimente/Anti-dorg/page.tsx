...
export default function Anti_drog() {
    ...
    useEffect(() => {
        ...
        fetchDocxFile(siteConfig.evenimente.antidorg_introd, setIntroContent);

        // Fetch text for "Desfasurare" when the component mounts
        fetchDocxFile(siteConfig.evenimente.antidorg_desf, setDesfContent);
    }, []);
