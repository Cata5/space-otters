...
export default function Wild_tech() {
    ...
    useEffect(() => {
        ...
        fetchDocxFile(siteConfig.evenimente.wild_tech_introd, setIntroContent);

        // Fetch text for "Desfasurare" when the component mounts
        fetchDocxFile(siteConfig.evenimente.wild_tech_desf, setDesfContent);
    }, []);
